...
<div class="grid two-panels masters-grid">
  <div class="card">
    ...
    <form method="post" class="form"><?php csrf_input(); ?>
      ...
      <div class="actions-inline"><button class="btn primary" type="submit"><?= $edit['id'] ? 'Save Changes' : 'Add Medicine' ?></button><?php if($edit['id']): ?><a class="btn" href="medicines_master.php">Cancel</a><?php endif; ?></div>
    </form>
  </div>
  <div class="card">
    <form method="get" class="toolbar compact-toolbar"><input type="text" name="q" value="<?= e($q) ?>" placeholder="Search medicine, category"><button class="btn" type="submit">Filter</button><?php if($q !== ''): ?><a class="btn" href="medicines_master.php">Reset</a><?php endif; ?></form>
