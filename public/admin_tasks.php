...
<div class="card">
  <div style="display:flex;align-items:flex-end;justify-content:space-between;gap:12px;flex-wrap:wrap">
    ...
    <form method="get" action="" class="form" style="display:flex;gap:10px;flex-wrap:wrap;align-items:flex-end">
      ...
      <a class="btn" href="<?= url('admin_tasks.php') ?>">Reset</a>
    </form>
  </div>
            ...
            <tr>
              ...
              <td>
                <div style="display:flex;gap:8px;flex-wrap:wrap">
                  <a class="btn tiny" href="<?= url('task_view.php?id='.(int)$r['id']) ?>">View</a>
                  <a class="btn tiny" href="<?= url('task_edit.php?id='.(int)$r['id']) ?>">Edit</a>
