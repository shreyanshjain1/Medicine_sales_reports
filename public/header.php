...
<header class="topbar glass">
  ...
  <nav class="nav titlecase">
    ...
    <a class="<?= $active==='report_add.php'?'active':'' ?>" href="<?= url('reports/report_add.php') ?>">Add Report</a>
    <?php if (is_manager()): ?>
    ...
    <?php endif; ?>
    <a class="<?= $active==='profile.php'?'active':'' ?>" href="<?= url('auth/profile.php') ?>">Profile</a>
...
<aside class="sidebar">
  <div class="card usercard">
    ...
    <form action="<?= url('tasks/event_add.php') ?>" method="post" class="form small" id="quickEventForm">
      <?php csrf_input(); ?>
    ...
    <div class="quick-links">
      <a class="btn block titlecase" href="<?= url('reports/reports.php') ?>">View Reports</a>
      <a class="btn block primary titlecase" href="<?= url('reports/report_add.php') ?>">Add New Report</a>
      <?php if (is_manager() || is_district_manager()): ?>
